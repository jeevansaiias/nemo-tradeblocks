...
const strategyOptions = [
  { label: "It's ORBin time!", value: "orb" },
  { label: "McRib w Lettuce, Pickles, & Special Sauce", value: "mcrib" },
  { label: "The Overnight SPY Who Loved Me", value: "overnight-spy" },
  { label: "Hump Day, Half-Baked Calendar - 1/2", value: "hump-day" },
  { label: "Theta Tuesday Calendar - 2/3", value: "theta-tuesday" },
  { label: "1/2 DD | ATM | Exit Pts ITM", value: "dd-atm" },
  { label: "Monday 2/4 DC", value: "monday-dc" },
  { label: "Monday JFSP", value: "monday-jfsp" },
  { label: "0DTE IF Friday", value: "dte-friday" },
  { label: "Friday DC 5/7 25D", value: "friday-dc" },
];

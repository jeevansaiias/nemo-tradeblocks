...
class GeekisticsCalculator:
    ...
    def calculate_all_geekistics_stats(self, trades_data: List[Dict], daily_log_data: List[Dict] = None, is_filtered: bool = False) -> Dict[str, Any]:
        """
        ...
        if is_filtered:
            calculated_strategy_capital = self._calculate_strategy_allocated_capital(trades_data, initial_capital)
        ...
        cagr = self.calculate_cagr(trades_data, strategy_allocated_capital, daily_log_data if use_daily_log_for_risk else None)
        sharpe_ratio = self.calculate_sharpe_ratio(trades_data, daily_log_data if use_daily_log_for_risk else None)
        sortino_ratio = self.calculate_sortino_ratio(trades_data, daily_log_data if use_daily_log_for_risk else None)
        calmar_ratio = self.calculate_calmar_ratio(trades_data, strategy_allocated_capital, daily_log_data if use_daily_log_for_risk else None)
        ...
        if use_daily_log_for_risk:
            ...
            max_drawdown = calculate_max_drawdown_from_portfolio_values(trades_data, strategy_allocated_capital)
        time_in_dd = self.calculate_time_in_drawdown(trades_data, strategy_allocated_capital, daily_log_data if use_daily_log_for_risk else None)
        ...
        return {
            ...
            "config_used": {
                ...
                "risk_free_rate": self.risk_free_rate * 100,  # Convert back to percentage for display
    ...
    def calculate_cagr(self, trades_data: List[Dict], initial_capital: float = 10000, daily_log_data: List[Dict] = None) -> float:
    ...
    def calculate_sharpe_ratio(self, trades_data: List[Dict], daily_log_data: List[Dict] = None) -> float:
    ...
    def calculate_sortino_ratio(self, trades_data: List[Dict], daily_log_data: List[Dict] = None) -> float:
    ...
    def calculate_calmar_ratio(self, trades_data: List[Dict], initial_capital: float = 10000, daily_log_data: List[Dict] = None) -> float:
        ...
        if daily_log_data:
            ...
            max_drawdown = calculate_max_drawdown_from_portfolio_values(trades_data, initial_capital)
    ...
    def calculate_time_in_drawdown(self, trades_data: List[Dict], initial_capital: float = 10000, daily_log_data: List[Dict] = None) -> float:
    ...
    def _get_daily_returns(self, trades_data: List[Dict], daily_log_data: List[Dict] = None) -> List[float]:
    ...
    def _calculate_strategy_allocated_capital(self, trades_data: List[Dict], full_portfolio_capital: float) -> float:
        """

            ...
            dmc.Group(
                [
                    ...
                    dmc.Group(
                        [
                            dmc.Button(
                                "Cancel", id="settings-cancel-button", variant="light", color="gray"
                            ),
                            dmc.Button(
                                "Save Settings",
...
def create_config_indicator(config_data, initial_capital=None):
    ...
    badges.extend(
        [
            dmc.Badge(f"RFR: {risk_free_rate}%", variant="light", color="green", size="sm"),
            dmc.Badge(f"{annualization_factor}d", variant="light", color="orange", size="sm"),
        ]
    )

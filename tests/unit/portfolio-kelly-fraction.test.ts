...
describe('Portfolio Kelly Fraction Two-Layer System', () => {
  ...
  const createTestTrades = (): Trade[] => {
    return [
      // 2 wins of $150 each
      { id: '1', strategy: 'TestStrategy', dateOpened: new Date('2024-01-01'), pl: 150, premium: 100 } as Trade,
      { id: '2', strategy: 'TestStrategy', dateOpened: new Date('2024-01-02'), pl: 150, premium: 100 } as Trade,
      // 2 losses of $75 each
      { id: '3', strategy: 'TestStrategy', dateOpened: new Date('2024-01-03'), pl: -75, premium: 100 } as Trade,
      { id: '4', strategy: 'TestStrategy', dateOpened: new Date('2024-01-04'), pl: -75, premium: 100 } as Trade,
    ];
  };
